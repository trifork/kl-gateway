...
WORKDIR /tmp
RUN git clone --branch rel_5_3_0 https://github.com/hapifhir/hapi-fhir-jpaserver-starter.git /tmp
COPY application.yaml /tmp/src/main/resources/application.yaml
##
